...
public class BrowserController {
    ...
    @PostMapping
    public ResponseEntity<Page<BrowserResponse>> getAllBrowserByUser(@RequestBody PageInfo pageInfo){
        PageRequest pageRequest = PageRequest.of(pageInfo.getIndex(), pageInfo.getSize());
        return ResponseEntity.ok(browserService.getAllByUser(profile.getId(),pageRequest));
    }
    @DeleteMapping
