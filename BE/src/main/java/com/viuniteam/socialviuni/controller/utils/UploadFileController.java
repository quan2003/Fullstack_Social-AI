...
public class UploadFileController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<List<ImageResponse>> upload(@RequestParam(value = "files", required = false) MultipartFile[] files) throws ExecutionException, InterruptedException {
        if(files.length <= 10){
